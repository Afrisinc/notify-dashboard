      ...
      <div style={{ display: 'flex', gap: 12, marginBottom: 16, flexWrap: 'wrap' }}>
        ...
        {[
          ...
          <select
            key={i}
            value={sel.value}
            onChange={(e) => sel.setValue(e.target.value)}
            style={{
              background: 'hsl(224,14%,10%)',
              border: `1px solid hsl(224,14%,16%)`,
              borderRadius: 8,
        ...
        {filtered.map((l, i) => (
          <div
            ...
            style={{
              ...
              gridTemplateColumns: '1fr 1.2fr 1.5fr 80px 1fr 90px 70px',
              padding: '13px 20px',
              borderBottom: i < filtered.length - 1 ? `1px solid hsl(224,14%,11%)` : 'none',
              alignItems: 'center',
            ...
            <div style={{ display: 'flex', gap: 10, marginTop: 24 }}>
              ...
              <button
                ...
                style={{
                  ...
                  fontWeight: 600,
                  cursor: 'pointer',
                  boxShadow: '0 2px 12px rgba(2,147,228,0.3)',
                  display: 'flex',
                  alignItems: 'center',
                  justifyContent: 'center',
                  gap: 8,
